...
6. For factors with relatively low pval_test_l, I did GWAS analysis using all GTEx samples(670 samples). In the association tests, first 10 genotype pcs were included as covariants.
...
## Factors from Module 1

- PLIER - canonicalPathways. You can find the factor construction and evaluation [here](https://xsun1229.github.io/factor_analysis/modu_factor_pliercanon.html)

## Prediction models for factors from Module 1

In this part, I trained prediction models for factors inferred from last part. The workflow is the same with the workflow in 'Prediction models for factors'.

- PLIER - canonicalPathways. [For more details](https://xsun1229.github.io/factor_analysis/modu_train_pliercanon.html)

## LDSC for factors from Module 1

In this part, I adopted [ldsc](https://github.com/bulik/ldsc) to detect the heritability enrichment of sevral factors from Module 1. The worlflow is the same with before.

[For more details](https://xsun1229.github.io/factor_analysis/modu_ldsc_pliercanon.html)
