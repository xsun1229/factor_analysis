...
## **3.1 Factor Construction and heritability evaluation**
...
**PCs from KEGG pathways**
  
  1-5 PCs for each KEGG pathway were calculated by PCA. We have 1646 PCs in total.
  
  [For more details](https://xsun1229.github.io/factor_analysis/eval_kegg_cedar.html)


## **3.2 Prediction models for factors(GTEx)**
...
**PLIER**
  ...
  [Results for plier- MSigDB pathway factors](https://xsun1229.github.io/factor_analysis/plier_msigdb.html)(**latest results 07/21**)
