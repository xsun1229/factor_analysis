...
We pooled all cell types to check if the inflation from random data (Platelet, T cell (CD8+)) dominant the whole data set.
...
##### qqplot
load("/project2/xinhe/xsun/CEDAR/ACAT_randomsnp_regress_peer/results/calibratedbytrait_acat_real_p.rdata")
type <- c("B cell (CD19+)","Monocyte (CD14+)","Leukocyte (CD15+)","Platelet","T cell (CD4+)","T cell (CD8+)")
plot <- list()
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
load("/project2/xinhe/xsun/CEDAR/ACAT_randomsnp_regress_peer/results/summary_fdr_calibratedbytrait_acat_real_p.rdata")
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
load("/project2/xinhe/xsun/CEDAR/ACAT_randomsnp_regress_peer/results/summarybytrait_fdr_calibratedbytrait_acat_real_p.rdata")
