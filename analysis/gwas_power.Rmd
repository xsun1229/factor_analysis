...
## Results- eliminate weak instrument bias-using same data
...
## Results- eliminate weak instrument bias-using YFS data
...
T1D pathway contains 174 genes(Ensemble ID), the GTEx expression data just cover 36 of them. 8 of these 36 genes has pvalue less than 0.01.   52
...
```{r echo=FALSE}
load("/project2/xinhe/xsun/website/factor_analysis/output/sum_cgl001_lv47_YFSs.rdata")
DT::datatable(summary_loading_001, options = list(pageLength =10))
```
