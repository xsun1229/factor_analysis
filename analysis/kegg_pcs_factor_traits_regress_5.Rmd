...
After deleting the pairs whose 'num_snp_noMHC' == 0, we got 747 pairs. There are 134 pairs show sign consistency (have p-values < 0.05 in resampling). There are 38 pairs at p-value < 0.01).  
