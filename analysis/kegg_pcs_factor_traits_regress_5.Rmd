...
```{r echo=FALSE}
load("/project2/xinhe/xsun/website/factor_analysis/output/info_table_annot_pval_MHC_kegg_pc_reg_5.rdata")
...
```{r echo=FALSE}
load("/project2/xinhe/xsun/website/factor_analysis/output/info_table_annot_pval_kegg_pc_reg_5.rdata")
DT::datatable(final_full, options = list(pageLength =20))
```
