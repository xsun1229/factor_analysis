...
We did association tests for PCs and SNPs in each trait-GWAS. The association tests were corrected by 10 whole genome PCs + GTEx:Sequencing platform,Sequencing protocol,Sex + AGE
...
```{r echo=T, eval=FALSE}
chr10_102727686_G_A_b38 : row 8 and row 15
chr3_141286732_A_C_b38 : row 19 ,row 21, row 23
chr19_1026478_G_T_b38 : row 20 and row 22
chr6_26463347_G_T_b38: row 1 and row 24
```
...
```{r echo=T, eval=FALSE}
chr1_113611678_T_C_b38 : row 3, row 6, row 14, row 18
chr1_113276758_C_T_b38 : row 13, row 15, row 17
chr10_6126327_G_A_b38 : row 5, row 11
```
