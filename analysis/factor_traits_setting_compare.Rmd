...
<figure class="half">
    <img src="https://github.com/xsun1229/factor_analysis/raw/master/output/enrichment_compare_more.jpeg" width="100%">
</figure>
...
```{r echo=FALSE}
sum <- read.table("/project2/xinhe/xsun/website/factor_analysis/output/summary_snp3_d1k_wb_reactome.txt",fill = T, header = T, sep ="\t")
