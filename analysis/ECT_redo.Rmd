...
for (i in 1:length(path)){
  ...
  if (sum(df_pass$fdr_ECT < 0.1) > 0) {
    tmp <- df_pass[df_pass$fdr_ECT < 0.1,]
    tmp$celltype <- type[i]
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
load("/project2/xinhe/xsun/CEDAR/4.B_cell_kegg/9.pcs_40genes_rerun/2.ECT/results/ECT_summary_table_mbeadded.rdata")
DT::datatable(df_pass, options = list(pageLength =5))
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
df_sum_15 <- df_pass[df_pass$num_snp_pass_cutoff >= 5,]
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
load("/project2/xinhe/xsun/CEDAR/6.CD14_positive_monocyte_kegg/9.pcs_40genes_rerun/2.ECT/results/ECT_summary_table_mbeadded.rdata")
DT::datatable(df_pass, options = list(pageLength =5))
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
load("/project2/xinhe/xsun/CEDAR/8.CD15_positive_leukocyte_kegg/9.pcs_40genes_rerun/2.ECT/results/ECT_summary_table_mbeadded.rdata")
DT::datatable(df_pass, options = list(pageLength =5))
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
load("/project2/xinhe/xsun/CEDAR/16.platelet_kegg/9.pcs_40genes_rerun/2.ECT/results/ECT_summary_table_mbeadded.rdata")
DT::datatable(df_pass, options = list(pageLength =5))
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
load("/project2/xinhe/xsun/CEDAR/10.T_cell_kegg/9.pcs_40genes_rerun/2.ECT/results/ECT_summary_table_mbeadded.rdata")
DT::datatable(df_pass, options = list(pageLength =5))
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
load("/project2/xinhe/xsun/CEDAR/14.thymocyte_kegg/9.pcs_40genes_rerun/2.ECT/results/ECT_summary_table_mbeadded.rdata")
DT::datatable(df_pass, options = list(pageLength =5))
```
