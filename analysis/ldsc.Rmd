...
Apart from these annotations, I also used annotations provided by 'ldsc'. ** In my results, the annotation end with '.narroPeaks' and '.OpenChrom' are our own annotations. Others are ldsc-provided annotations. **
