...
2. Use FUSION to train weigths for part1. The cis-snp here are the snps within 500kb from TSS of gene. The models here are LASSO, elastic_net and top1.
...
2. 1445 genes have heitability p_value > 0.01, so I got 1445 weights.

3. 1306 of 1445 weights can be used to impute gene expression data.
...
```{r echo=FALSE}
load("/project2/xinhe/xsun/website/factor_analysis/output/compare_sum.rdata")
