...
```{r echo=FALSE}
sum <- read.table("/project2/xinhe/xsun/website/factor_analysis/output/simple_sum_kegg_pcs.txt", header = T)
...
```{r echo=FALSE}
sum <- read.table("/project2/xinhe/xsun/website/factor_analysis/output/simple_sum_noMHC_kegg_pcs.txt", header = T)
DT::datatable(sum, options = list(pageLength =20))
```
...
<figure class="half">
    <img src="https://github.com/xsun1229/factor_analysis/raw/master/output/pval_compare_allpair_noMHC_pcs.jpeg" width="60%">
</figure>
