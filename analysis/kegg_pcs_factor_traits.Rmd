...
<figure class="half">
    <img src="https://github.com/xsun1229/factor_analysis/raw/master/output/pval_compare_allpair_pcs.jpeg" width="60%">
</figure>

SNPs in MHC area are excluded:

<figure class="half">
    <img src="https://github.com/xsun1229/factor_analysis/raw/master/output/pval_compare_noMHC_pcs.jpeg" width="60%">
</figure>
...
<figure class="half">
    <img src="https://github.com/xsun1229/factor_analysis/raw/master/output/estimate_compare_allpair_pc.jpeg" width="60%">
</figure>

We also made a scatter plot for the p-values from the fitting and IVW estimate. 

<figure class="half">
    <img src="https://github.com/xsun1229/factor_analysis/raw/master/output/pval_org_compare_allpair_pc.jpeg" width="60%">
</figure>
...
<figure class="half">
    <img src="https://github.com/xsun1229/factor_analysis/raw/master/output/ivw_debug_pc.jpeg" width="60%">
</figure>

To study the resampling results for this case deepling, we made several other plots to read the results.

This plot shows the slope in fitting vs IVW estimate results from 1000 times resampling. The points are near the y=x line. 

<figure class="half">
    <img src="https://github.com/xsun1229/factor_analysis/raw/master/output/ivw_debug_pc_resampling_estimate.jpeg" width="60%">
</figure>

It means that the slope and IVW estimates are similar and the reasons why the resampling p-values differ a lot do not come from the estimators. 
...
<figure class="half">
    <img src="https://github.com/xsun1229/factor_analysis/raw/master/output/ivw_debug_pc_pval_est.jpeg" width="60%">
</figure>
