---
title: "Heritability of PCs (PEER regressed out)"
author: "XSun"
date: "2022-10-12"
...
We computed the heritability of PCs (PEER factor regressed) with gcta.

The results are a little better than the [results](https://xsun1229.github.io/factor_analysis/hsq_pc_fdr.html) where the PEER factors are not regressed out.
...
for (i in 1:length(celltypes)){
  ...
  folder_celltype <- paste0("/project2/xinhe/xsun/CEDAR/",path[i],"/8.regress_out_peer/2peer/3.heritability/")
