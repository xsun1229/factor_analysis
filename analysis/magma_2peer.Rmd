---
title: "MAGMA results (PEER regressed)"
author: "XSun"
date: "2022-10-20"
...
## Results for the pairs have ECT FDR < 0.1

```{r echo=FALSE}
load("/project2/xinhe/xsun/CEDAR/MAGMA_regress_peer/results/CEDAR_KEGG_compare.rdata")
ect <- ect[ect$fdr_ECT < 0.1,]
DT::datatable(ect, options = list(pageLength =5))
```

## Results for the pairs have ECT FDR < 0.2
...
load("/project2/xinhe/xsun/CEDAR/MAGMA_regress_peer/results/final_results_random_included.rdata")
