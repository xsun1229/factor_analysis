...
We computed the FDR using qvalues and lfdr for the calibrated ACAT p-values.

We computed both by traits and by cell types.

## qvalues by cell types

```{r echo=FALSE, message=FALSE, warning=FALSE}
load("/project2/xinhe/xsun/CEDAR/ACAT_randomsnp/calibrated_fdr/summary_qvalues_correct_by_celltype.rdata")
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
load("/project2/xinhe/xsun/CEDAR/ACAT_randomsnp/calibrated_fdr/summary_lfdr_correct_by_celltype.rdata")
DT::datatable(summary, options = list(pageLength =20))
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
load("/project2/xinhe/xsun/CEDAR/ACAT_randomsnp/calibrated_fdr/summary_qvalue_correct_by_trait.rdata")
DT::datatable(summary, options = list(pageLength =20))
```

## lfdr by traits
```{r echo=FALSE, message=FALSE, warning=FALSE}
load("/project2/xinhe/xsun/CEDAR/ACAT_randomsnp/calibrated_fdr/summary_fdr_correct_by_trait.rdata")
DT::datatable(summary, options = list(pageLength =20))
```
