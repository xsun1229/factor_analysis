...
for (t in 1:length(type)) {
  ...
  load(paste0(folder_path,"results/number_snp_fdr01_allpairs_fdr01.rdata"))
...
for (i in 1:length(type)){ 
  ...
  file_ect_results <- paste0("/project2/xinhe/xsun/CEDAR/",path[i],"/9.pcs_40genes_rerun/2.ECT/results/ECT_results_fdr01.rdata")
  load(file_ect_results)
  
  file_ect_summary <- paste0("/project2/xinhe/xsun/CEDAR/",path[i],"/9.pcs_40genes_rerun/2.ECT/results/ECT_summary_table_fdr01.rdata")
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
load("/project2/xinhe/xsun/CEDAR/4.B_cell_kegg/9.pcs_40genes_rerun/2.ECT/results/ECT_summary_table_fdr01.rdata")
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
load("/project2/xinhe/xsun/CEDAR/6.CD14_positive_monocyte_kegg/9.pcs_40genes_rerun/2.ECT/results/ECT_summary_table_fdr01.rdata")
DT::datatable(df_sum, options = list(pageLength =5))
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
load("/project2/xinhe/xsun/CEDAR/8.CD15_positive_leukocyte_kegg/9.pcs_40genes_rerun/2.ECT/results/ECT_summary_table_fdr01.rdata")
DT::datatable(df_sum, options = list(pageLength =5))
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
load("/project2/xinhe/xsun/CEDAR/16.platelet_kegg/9.pcs_40genes_rerun/2.ECT/results/ECT_summary_table_fdr01.rdata")
DT::datatable(df_sum, options = list(pageLength =5))
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
load("/project2/xinhe/xsun/CEDAR/10.T_cell_kegg/9.pcs_40genes_rerun/2.ECT/results/ECT_summary_table_fdr01.rdata")
DT::datatable(df_sum, options = list(pageLength =5))
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
load("/project2/xinhe/xsun/CEDAR/14.thymocyte_kegg/9.pcs_40genes_rerun/2.ECT/results/ECT_summary_table_fdr01.rdata")
DT::datatable(df_sum, options = list(pageLength =5))
```
