---
title: "Effect Size Consistency Tests (SNP FDR cutoff: 0.2, PEER regressed)"
author: "XSun"
date: "2022-10-03"
...
for (i in 1:length(path)){
  folder_path <- paste0("/project2/xinhe/xsun/CEDAR/",path[i],"/8.regress_out_peer/2peer/2.ECT/")
...
<!-- load("/project2/xinhe/xsun/CEDAR/4.B_cell_kegg/8.regress_out_peer/2peer/2.ECT/results/assoc_results_harmo_2snps.rdata") -->
<!-- trait <- "plt" -->
<!-- factor <- "pwy142_pc3" -->
<!-- fdr_cutoff <- 0.2 -->
...
<!--   geom_label(aes(x = -0.7, y = -0.03), hjust = 0,  -->
...
<!-- load("/project2/xinhe/xsun/CEDAR/6.CD14_positive_monocyte_kegg/8.regress_out_peer/2peer/2.ECT/results/assoc_results_harmo_2snps.rdata") -->
<!-- trait <- "EUR.UC" -->
<!-- factor <- "pwy121_pc3" -->
<!-- fdr_cutoff <- 0.2 -->
<!-- dat <- assoc_harmo_all[[trait]][[factor]] -->
...
<!--   geom_label(aes(x = -0.25, y = 0.3), hjust = 0,  -->
<!--              label = paste("rsq = ",signif(summary(fit)$r.squared, 3), -->
...
<!-- load("/project2/xinhe/xsun/CEDAR/16.platelet_kegg/8.regress_out_peer/2peer/2.ECT/results/assoc_results_harmo_2snps.rdata") -->
<!-- trait <- "ret" -->
<!-- factor <- "pwy142_pc1" -->
<!-- fdr_cutoff <- 0.2 -->
<!-- dat <- assoc_harmo_all[[trait]][[factor]] -->
...
<!--   geom_label(aes(x = 0, y = 0.1), hjust = 0,  -->
<!--              label = paste("rsq = ",signif(summary(fit)$r.squared, 3), -->
