...
1. 14,976 of 19,696 genes have cis-snps.

2. I got 180 weights from lasso model, 179 from elastic-net model, 179 weights from blup models.
...
<figure class="half">
    <img src="https://github.com/xsun1229/factor_analysis/raw/master/output/hist_cgonesam_ciseqtls.jpeg" width="200%">
</figure>

- Lasso model

```{r echo=FALSE}
load("/project2/xinhe/xsun/website/factor_analysis/output/compare_sum_lasso_ciseqtls.rdata")
...
```{r echo=FALSE}
load("/project2/xinhe/xsun/website/factor_analysis/output/compare_sum_enet_ciseqtls.rdata")
DT::datatable(summary, options = list(pageLength =10))
```
...
```{r echo=FALSE}
load("/project2/xinhe/xsun/website/factor_analysis/output/compare_sum_blup_ciseqtls.rdata")
DT::datatable(summary, options = list(pageLength =10))
```
