...
for (i in 1:length(path)){
  ...
  load(paste0(folder_path,"results/ECT_summary_table_fisher_filtered.rdata"))
...
for (i in 1:length(type)){ 
  ...
  file_ect_summary <- paste0("/project2/xinhe/xsun/CEDAR/",path[i],"/9.pcs_40genes_rerun/2.ECT/results/ECT_summary_table_fisher_filtered.rdata")
