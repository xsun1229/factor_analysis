---
title: "Effect Size Consistency Tests (SNP FDR < 0.2, FDR corrected, Fisher FDR < 0.1)"
author: "XSun"
date: "2022-11-24"
...
2. For the pairs have multiple snps (>=3) passing FDR < 0.2 && Fisher FDR < 0.1, do ECT
...
for (i in 1:length(path)){
  ...
  load(paste0(folder_path,"results/ECT_summary_table_fisher_filtered_p_005.rdata"))
...
for (i in 1:5){ 
  ...
  file_ect_summary <- paste0("/project2/xinhe/xsun/CEDAR/",path[i],"/9.pcs_40genes_rerun/2.ECT/results/ECT_summary_table_fisher_filtered_p_005.rdata")
...
all1 <- grid.arrange(p1[[1]],p1[[2]],p1[[3]],p1[[4]],p1[[5]], nrow = 2)
all2 <- grid.arrange(p2[[1]],p2[[2]],p2[[3]],p2[[4]],p2[[5]], nrow = 2)
